  ...
  return (
    <App.Flex className={styles.container}>
      <App.Container maxWidth={1230}>
        <App.Flex column gap={32} sx={{ paddingTop: 32 }}>
          <App.Text size={24} weight={700} height={1}>Tournaments</App.Text>

          <App.Flex column className={styles.table}>
            <App.Flex fullWidth className={styles.header} align="center" justify="space-between">
              <App.Flex column gap={4}>
                <App.Flex row align="center" gap={8}>
                  <Image src={'/images/brett-logo.png'} width={24} height={24} alt="" />
                  <App.Text uppercase size={16} weight={700} height={1} gradient="linear-gradient(180deg, #FFF 0%, #C7C7C7 100%)">BRETT Brawl</App.Text>
                </App.Flex>
              ...
              <App.Button primary2 onClick={handleBrett}>Trade now</App.Button>
            </App.Flex>

            <App.Flex row className={styles.row}>
              <App.Flex width={[100, 50]} center>
                <App.Text center weight={400} height={1}>Rank</App.Text>
              </App.Flex>

              <App.Flex width={[200, 'auto']} flex={[null, 1]} align="center">
                <App.Text weight={400} height={1}>Address</App.Text>
              </App.Flex>

              <App.Flex width={['auto', 56]} flex={[1, null]} center>
                <App.Text center weight={400} height={1}>Points</App.Text>
              </App.Flex>

              <App.Flex flex={1} align="center" justify="flex-end">
                <App.Text right weight={400} height={1}>Rewards</App.Text>
              </App.Flex>
            </App.Flex>
            ...
            {loading ? (
              ...
              tournament?.leaderboard && tournament.leaderboard.length ? (
                tournament.leaderboard.map((item, index) => (
