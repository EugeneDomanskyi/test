        ...
        <App.Flex column fullWidth gap={32}>
          <App.Container maxWidth={1230}>
            <App.Flex row justify="space-between">
              <App.Flex column gap={16} align="flex-start">
                <App.Text size={24} weight={600} height={1}>{t('My Earnings')}</App.Text>
                <App.Text weight={400} height={1} color="#FFFFFF99">{t('Earn points every minute that order lives on the orderbook based on the order size.')}</App.Text>
                <App.Button primary2>{t('Share Your Progress')} <App.Icon icon="arrow-45" /></App.Button>
              </App.Flex>

              <App.Flex row gap={24}>
                <App.Flex column width={200} justify="center" gap={12} className={styles.box}>
                  <App.Text weight={400} height={1}>{t('Total Earnings')}</App.Text>
                  <App.Text size={48} weight={600} height={1}>500 <App.Text inline weight={600} height={1}>USDT</App.Text></App.Text>
                </App.Flex>

                <App.Flex column width={200} justify="center" gap={12} className={styles.box}>
                  <App.Text weight={400} height={1}>{t('Points earned')}</App.Text>
                  <App.Text size={48} weight={600} height={1}>46,915</App.Text>
                </App.Flex>
              </App.Flex>
            </App.Flex>
          </App.Container>
            ...
            <App.Flex column className={styles.table}>
              <App.Flex row className={styles.row}>
                ...
                <App.Flex width={200} center>
                  <App.Text center weight={600} height={1} color="#A6DC37">{t('Transaction Details')}</App.Text>
                </App.Flex>
                ...
                <App.Flex row className={styles.row}>
                  ...
                  <App.Flex width={200} center>
                    <App.Flex center width={160} height={48} className={styles.claimed}>
                      <App.Text size={16} weight={600} height={1} color="#737373">{t('Claimed')}</App.Text>
                    </App.Flex>
                  </App.Flex>
                </App.Flex>
              </App.Flex>
