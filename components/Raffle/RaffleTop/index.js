  ...
  return (
    <App.Flex column>
      <App.Flex className={styles.top}>
        <App.Container>
          <App.Flex column gap={64} sx={{ padding: '70px 0 54px' }}>
            <App.Flex column>
              <App.Text center size={68} height={1} family="ClashDisplay" gradient="linear-gradient(151deg, #FFF -0.73%, rgba(255, 255, 255, 0.50) 132.2%)">The TKeys Raffle</App.Text>
              <App.Text center size={16}>Join raffles with TKeys for chances to win USDT and more on Polygon!</App.Text>
            </App.Flex>
      ...
      <App.Flex row center gap={8} className={styles.awards}>
        <App.Flex center gap={4}>
          <Image src="/images/raffle/icon-crown.png" width={18} height={17} />
