...
const SellModalComplete = ({ token, amount, onComplete }) => {
  ...
  return (
    <App.Flex column>
      <App.Flex column gap={8} align="center" className={styles.content}>
        ...
        <App.Text center size={20} weight={600}>Your selling Was Successful!</App.Text>
        ...
        <App.Flex row center gap={8} className={styles.container}>
          ...
          <App.Text color="#B9B8C5">You have sold {amount} {token.collection} NFT{amount > 1 ? 's' : ''}</App.Text>
        </App.Flex>
      </App.Flex>
