    ...
    <App.Flex className={styles.container}>
      <App.Container>
        <App.Flex column gap={32} className={styles.parent}>
            ...
            <App.Flex row width={['60%', '100%']} gap={[0, 12]}>
              <App.Flex column gap={[16, 8]} flex={1}>
                ...
                <App.Flex column gap={8}>
                  ...
                  <a href="https://tegro.com/privacypolicy.pdf" target="_blank" rel="noreferrer">
                    <App.Text inline size={[16, 12]} color="#4C69FF">Privacy Policy</App.Text>
                  </a>

                  <a href="https://tegro-imagekit-tora.s3.eu-central-1.amazonaws.com/USER+AGREEMENT.pdf" target="_blank" rel="noreferrer">
          ...
          <App.Text center size={12} color="#9996B1">Tegro © 2023</App.Text>
        </App.Flex>
      </App.Container>
    </App.Flex>
  )
