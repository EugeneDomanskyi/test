      ...
      <App.Flex row full align="center">
        <App.Flex row full align="center" gap={[64, 16]} justify={['flex-start', 'space-between']}>
          ...
          <App.Flex row height="100%" align="center" className={styles.navItems}>
            <App.Flex sx={{ position: 'relative' }} fullHeight id="product" className={styles.navItemBox}>
              <App.Flex className={styles.navbarItem}>
                ...
                <App.Flex column>
                  <App.Flex row align="center" gap={8} onClick={handleProductClick('x')} className={styles.menuItem}>
                    ...
                    <App.Flex column gap={[8, 0]} flex={1}>
                      <App.Text size={[18, 14]} weight={600}>CEX-DEX</App.Text>
                      <App.Text size={[14, 12]} color="#9f9dad">CEX-like Orderbook Trading in a DEX</App.Text>
                    </App.Flex>
                  </App.Flex>
                  ...
                  <App.Flex row align="center" gap={8} onClick={handleProductClick('classic')} className={styles.menuItem}>
                    ...
                    <App.Flex column gap={[8, 0]} flex={1}>
                      ...
                      <App.Text size={[14, 12]} color="#9f9dad">Centralized exchange to trade NFTs as easy as ERC-20s!</App.Text>
                    </App.Flex>
                  </App.Flex>
                </App.Flex>
              </div>
            ...
            <App.Flex sx={{ position: 'relative' }} fullHeight id="resources" className={styles.navItemBox}>
              <App.Flex className={styles.navbarItem}>
                <App.Flex center height="100%">
              ...
              <div className={cn(styles.menu, styles.menuLong, {[styles.active]: menuShow.resources})}>
                <App.Flex row gap={24} fullWidth>
                  ...
                  <App.Flex column flex={1}>
                    <a href="https://t.me/tegrochat?utm_source=website" target="_blank" rel="noreferrer" className={styles.menuItem}>
                      <App.Text inline size={[18, 14]} weight={600}>Telegram</App.Text>
                    </a>

                    <div className={styles.hr} />

                    <a href="https://www.linkedin.com/company/tegrofi?utm_source=website" target="_blank" rel="noreferrer" className={styles.menuItem}>
                      <App.Text inline size={[18, 14]} weight={600}>LinkedIn</App.Text>
                    </a>
                    ...
                    <a href="https://www.youtube.com/@tegrofi?utm_source=website" target="_blank" rel="noreferrer" className={styles.menuItem}>
                      <App.Text inline size={[18, 14]} weight={600}>YouTube</App.Text>
                    </a>
                  </App.Flex>
                </App.Flex>
              </div>
            ...
            <App.Flex sx={{ position: 'relative' }} fullHeight id="earn" className={styles.navItemBox}>
              <App.Flex className={styles.navbarItem}>
                <App.Flex center height="100%">
              ...
              <div className={cn(styles.menu, {[styles.active]: menuShow.earn})}>
                <App.Flex column flex={1}>
                  ...
                  <a href="https://classic.tegro.com/airdrop" target="_blank" rel="noreferrer" className={styles.menuItem}>
            ...
            {/* <App.Flex sx={{ position: 'relative' }} fullHeight id="partner" className={styles.navItemBox}>
              <App.Flex className={styles.navbarItem}>
                <App.Flex center height="100%">
              ...
              <div className={cn(styles.menu, {[styles.active]: menuShow.partner})}>
                <App.Flex column flex={1}>
                  <a href="mailto:partnerships@tegro.com" className={styles.menuItem}>
                    <App.Text inline size={[18, 14]} weight={600}>Contact</App.Text>
                  </a>

                  <div className={styles.hr} />

                  <a target="_blank" rel="noreferrer" className={cn(styles.menuItem, styles.disabled)}>
              ...
              <App.Flex column gap={16} sx={{padding: 16}}>
                  ...
                  <App.Flex row gap={24} fullWidth>
                    ...
                    <App.Flex column gap={8} flex={1}>
                      ...
                      <a href="https://t.me/tegrochat?utm_source=website" target="_blank" rel="noreferrer">
                        <App.Text inline size={14} weight={600}>Telegram</App.Text>
                      </a>
                    </App.Flex>

                    <App.Flex column gap={8} flex={1}>
                      <a href="https://www.linkedin.com/company/tegrofi?utm_source=website" target="_blank" rel="noreferrer">
                        <App.Text inline size={14} weight={600}>LinkedIn</App.Text>
                      </a>
                      ...
                      <a href="https://www.youtube.com/@tegrofi?utm_source=website" target="_blank" rel="noreferrer">
                        <App.Text inline size={14} weight={600}>YouTube</App.Text>
                      </a>
                    </App.Flex>
                  </App.Flex>
                </App.Flex>
                ...
                <App.Flex column gap={8}>
                  ...
                  <App.Flex column gap={8}>
                    ...
                    {/* <a href="https://classic.tegro.com/airdrop" target="_blank" rel="noreferrer">
                ...
                <App.Flex column gap={8}>
                  ...
                  <App.Flex column gap={8}>
                    ...
                    <a target="_blank" rel="noreferrer" className={styles.disabled}>
