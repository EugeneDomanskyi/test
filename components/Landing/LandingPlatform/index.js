      ...
      <App.Container>
        <App.Flex column center gap={[36, 8]} sx={[{ padding: '70px 0' }, { padding: '50px 0' }]}>
          ...
          <App.Flex direction={['row', 'column']} gap={[48, 24]} fullWidth>
            <App.Flex className={styles.banner} flex={1}>
              <App.Flex className={styles.bannerInner} />

              <App.Flex column gap={[24, 8]} className={styles.bannerContent}>
                ...
                <App.Flex row align="center" justify={['center', 'space-between']} gap={[32, 8]}>
                  ...
                  <App.Flex center className={styles.socialBox} onClick={handleSocialClick('facebook')}>
                    <App.Icon icon="facebook" />
                  </App.Flex>

                  <App.Flex center className={styles.socialBox} onClick={handleSocialClick('instagram')}>
