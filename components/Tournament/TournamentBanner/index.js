  ...
  return isMobile ? (
    ...
    <App.Flex direction={['row', 'column']} gap={24} className={styles.banner} sx={{ backgroundImage: `url('/images/${code}-banner-long.png')` }} align={['center', 'flex-start']} justify="space-between" onClick={handleExchange(tournament)}>
      <App.Flex column gap={8}>
        ...
        <App.Text uppercase size={[16, 14]} weight={900} height={1} gradient="linear-gradient(180deg, #FFF 0%, #C7C7C7 100%)">Get 1 GEM for every $1 traded!</App.Text>
      </App.Flex>
      ...
      <App.Flex column gap={8}>
        <App.Flex row gap={[16, 8]}>
          <App.Flex row center gap={6}>
            ...
            <App.Flex column gap={2}>
              <App.Text uppercase size={[16, 12]} weight={900} height={1}>Setup</App.Text>
              <App.Text size={[12, 9]} weight={500} height={1}>Trading Bot</App.Text>
            </App.Flex>
          </App.Flex>
          ...
          <App.Flex row center gap={6}>
            ...
            <App.Flex column gap={2}>
              ...
              <App.Text size={[12, 9]} weight={500} height={1}>{tournament.specialCurrency}</App.Text>
            </App.Flex>
          </App.Flex>
          ...
          <App.Flex row center gap={6}>
            <App.Text size={[34, 22]} weight={900} height={1} gradient="radial-gradient(193.17% 113.6% at 96.29% 4.49%, #FFF6A3 0%, #FFF066 34.61%, #FFCB45 68.83%, #FFBD13 100%)">5</App.Text>
        ...
        <App.Text size={14} weight={600} height={1} color="#FFFFFF99">Activate streaks with daily min. trade vol. of $1000!</App.Text>
      </App.Flex>
    </App.Flex>
  )
}
