  ...
  return (
    <App.Flex column>
      <App.Flex column gap={8} align="center" className={styles.content}>
        ...
        <App.Text center size={20} weight={600}>Your Redemption Was Successful!</App.Text>
        ...
        <App.Flex row center gap={8} className={styles.container}>
          ...
          <App.Text color="#B9B8C5">You have redeemed {amount} {token.collection} NFTs</App.Text>
        </App.Flex>
      </App.Flex>
