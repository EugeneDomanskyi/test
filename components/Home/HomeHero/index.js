  ...
  return (
    <App.Container maxWidth={1230}>
      <App.Flex column gap={32} align="center" className={styles.container}>
        <App.Flex column align="center" gap={24} width={570}>
          <App.Text center size={56} weight={800} height={1.2}>Earn More With Every Trade On Tegro</App.Text>
          <App.Text center size={28} weight={500} height={1.2} color="#FFFFFF99">Earn Gems, Win Auctions, and Get Tokens at Steal Prices <App.Text inline size={28} weight={500} height={1.2} color="#A6DC37">Up to 95% Off</App.Text>!</App.Text>
