    ...
    <App.Flex className={styles.mwebBack}>
      <App.Container maxWidth={1230}>
        <App.Flex column gap={32} align="center" className={styles.container}>
          <App.Flex column align="center" gap={24} width={[600, 'auto']}>
            <App.Text tag="h1" center size={[56, 32]} weight={800} height={1.2}>The Gen2 DEX for High-Frequency Trading</App.Text>
