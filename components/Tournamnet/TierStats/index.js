              ...
              ? <>
                  <App.Flex column gap={24} flex={1} justify={'flex-end'}>
                    ...
                    <App.Flex column align={'center'} justify={'center'} className={cn(styles.plate, styles.color)} height={250} width={'100%'}>
                      <App.Flex sx={{position: 'relative', marginBottom: 16}} align={'center'} justify={'center'}>
                        ...
                        <App.Text sx={{position: 'absolute', transform: 'scaleX(-1)'}} size={40}>🎯</App.Text>
                      </App.Flex>
                      <App.Text size={20} weight={700}>Volume</App.Text>
                      ...
                      <App.Text size={48} weight={700}>{numeral(walletResults.volume_remaining).format('0.[0]a')}</App.Text>
                    </App.Flex>
                  </App.Flex>
                    ...
                    <App.Flex gap={24} flex={1} align={'flex-end'}>
                      <App.Flex column className={cn(styles.plate, styles.wallet)} flex={1} height={286}>
                        ...
                        <App.Flex align={'center'} gap={8}>
                          ...
                          <App.Text inline onClick={handleCopy}><App.Icon icon={'copy'} /></App.Text>
                        </App.Flex>
                      </App.Flex>
        ...
        </App.Flex>
        {
          wallet
            ? <App.Flex flex={1} gap={24} column className={styles.mobile}>
                ...
                <App.Flex>
                  <App.Flex column align={'center'} justify={'center'} className={cn(styles.plate, styles.color)} height={250} width={'100%'}>
                    <App.Flex sx={{position: 'relative'}} align={'center'} justify={'center'}>
                      ...
                      <App.Text size={40} sx={{position: 'absolute', transform: 'scaleX(-1)'}}>🎯</App.Text>
                    </App.Flex>
