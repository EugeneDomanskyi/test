  ...
  return (
      <App.Flex width={'100%'} align={'flex-start'} className={styles.container}>
        <App.Flex height={'100%'} flex={1} column>
          <App.Flex justify={'start'} align={'start'}>
            <App.Flex align={'center'} justify={'center'} sx={{position: 'relative'}}>
              ...
              <App.Text size={32} sx={{position: 'absolute', transform: 'scaleX(-1)'}}>🚀</App.Text>
            </App.Flex>
          </App.Flex>
          {
            wallet
