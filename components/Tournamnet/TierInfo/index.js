...
const TierInfo = ({walletResults}) => {
  ...
  return (
      <App.Flex width={'100%'} align={'flex-start'} className={styles.container}>
        <App.Flex height={'100%'} flex={1} column>
          ...
          </svg>
          {
            wallet
              ...
              : <>
                  ...
                  <App.Text color={'#9B99AE'} size={14} weight={400} sx={{marginTop: 'auto', marginBottom: 12}}>Eu metus aliquam turpis commodo cursus. Volutpat tempus amet malesuada tincidunt.</App.Text>
        ...
        <App.Flex flex={1} justify={'flex-end'} align={'flex-start'}>
          <ProgressBar
