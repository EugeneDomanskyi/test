          ...
          connection.connected ? (
            ...
            <App.Flex column full className={styles.tiger}>
              <App.Container maxWidth={1230} height="100%">
                <App.Flex full column justify="center">
                  <App.Flex column align="flex-start" width={486} gap={32} sx={{ paddingBottom: '64px' }}>
                    <App.Text size={80} weight={700} height={1}>{t('Start your points')} <App.Text inline size={80} weight={700} height={1} color="#A6DC37">{t('Quest')}</App.Text></App.Text>
                    <App.Text size={16} weight={400} color="#FFFFFF99">{t('Join forces with fellow traders on a quest for glory and exclusive rewards. Connect your wallet to unleash the power of points and start your legendary journey.')}</App.Text>
