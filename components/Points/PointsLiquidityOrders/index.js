      ...
      <App.Flex column>
        ...
        <App.Flex column className={styles.table}>
          {!isMobile ? (
            ...
            <App.Flex row className={styles.row}>
              <App.Flex width={80} center>
                <App.Text center size={14} weight={[600, 400]}>01.04.24<br />10:15:01</App.Text>
              </App.Flex>
              ...
              <App.Flex width={128} column gap={4} center>
                <App.Flex row center gap={6}>
                  ...
                  <App.Text center size={[16, 14]} weight={600} height={1}>KRYPTONITE</App.Text>
                </App.Flex>
              ...
              <App.Flex width={44} center>
                <App.Flex center className={styles.more} onClick={handleMore({})}>
