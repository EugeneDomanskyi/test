      ...
      <App.Container maxWidth={1230}>
        <App.Flex column fullWidth gap={32}>
          <App.Flex fullWidth column gap={16}>
            <App.Text size={24} weight={600} height={1}>{t('Venture Through Partner Portals')}</App.Text>
            <App.Text size={16} weight={400} height={1} color="#9B99AE">{t('Engage with Tegro quests on platforms like Galxe, TaskOn, and more. Complete tasks, show your prowess, and rack up points across the Tegrosphere.')}</App.Text>
          </App.Flex>
                ...
                return (
                  <App.Flex key={item.id} column gap={16} className={styles.questBox}>
                    ...
                    <App.Flex row align="center" gap={12} sx={{ cursor: 'pointer' }} onClick={handleClick(item?.external_link)}>
                      <App.Text size={24} weight={600} height={1}>{item.name}</App.Text>
                    ...
                    <App.Flex row align="center" justify="space-between">
                      ...
                      <App.Text size={24} weight={600} height={1}>{item.points} {t('Points')}</App.Text>
                    </App.Flex>
                  </App.Flex>
                )
              })
