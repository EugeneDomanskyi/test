    ...
    <App.Flex column fullWidth gap={40}>
      {hasReferrals ? (
        <App.Flex row fullWidth gap={24}>
          <App.Flex column flex={45} className={cn(styles.box, styles.nopadding)}>
            <App.Flex column gap={8} height={320} fullWidth className={styles.chartBack}>
              <App.Flex center fullHeight width={240}>
                <PointsProgressCircle />
              </App.Flex>
            </App.Flex>
          </App.Flex>

          <App.Flex row flex={55} gap={32} className={styles.box}>
          </App.Flex>
        </App.Flex>
      ) : (
        <App.Flex row fullWidth gap={24}>
          ...
          <App.Flex column justify="space-between" flex={45} gap={8}>
            <App.Flex className={cn(styles.box, styles.nopadding)}>
              <App.Flex column gap={8} className={styles.step1}>
            ...
            <App.Flex className={cn(styles.box, styles.nopadding)}>
              <App.Flex column gap={8} className={styles.step2}>
            ...
            <App.Flex className={cn(styles.box, styles.nopadding)}>
              <App.Flex column gap={8} className={styles.step3}>
                <App.Text italic size={12} weight={700} family="Playfair Display" color="#A6DC37">{t('Step {{number}}', {number: 3})}</App.Text>
                <App.Text size={17} weight={600}>{t('Earn points everytime They Trade')}</App.Text>
              </App.Flex>
            </App.Flex>
      ...
      <App.Flex row fullWidth align="center" justify="space-between" gap={16}>
        <App.Flex>
          <App.Text size={24} weight={700}>{t('Refer a Friend & Earn')} <App.Text inline italic size={24} weight={700} family="Playfair Display">{t('upto $100k')}</App.Text></App.Text>
        </App.Flex>

        <App.Flex center gap={20}>
          <App.Flex align="center" justify="space-between" gap={16} className={styles.code}>
            <App.Text color="#9B99AE">{userCode}</App.Text>
            <App.Icon icon="copy" color="#9281C5" style={{ cursor: 'pointer' }} onClick={handleCopy} />
          </App.Flex>

          <App.ButtonGradient large onClick={handleInvite}>{t('Invite Friends with Unique Link')}</App.ButtonGradient>
        </App.Flex>
      </App.Flex>
    </App.Flex>
  )
