...
const PointsPopup = ({ onClose, onStart }) => {
  return (
    <App.Flex center className={styles.container}>
      <App.Flex column align="center" className={styles.content}>
        ...
        <Image src="/images/points/points-popup-bg.png" width={589} height={589} alt="" />
        
        <App.Flex column center className={styles.wrapper}>
          <Image src="/images/points/points-popup-text.png" width={464} height={78} className={styles.textImg} alt="" />

          <App.Text size={[20, 14]} weight={600} center>
            Join the Tegro Points Program
          </App.Text>
