  ...
  return (
    <App.Flex column fullWidth gap={40}>
      <App.Flex row wrap gap={30}>
        <App.Flex column gap={16} className={styles.tgrBox}>
          <App.Flex className={cn(styles.tgrImage, styles.gold)}>
            <App.Flex center className={styles.tgrSoon}>
        ...
        <App.Flex column gap={16} className={styles.tgrBox}>
          <App.Flex className={cn(styles.tgrImage, styles.silver)}>
            <App.Flex center className={styles.tgrSoon}>
              <App.Text italic size={20} weight={700} family="Playfair Display" color="#9B99AE">{t('Soon')}</App.Text>
            </App.Flex>
          </App.Flex>
        ...
        <App.Flex column gap={16} className={styles.tgrBox}>
          <App.Flex className={cn(styles.tgrImage, styles.bronze)}>
            <App.Flex center className={styles.tgrSoon}>
              <App.Text italic size={20} weight={700} family="Playfair Display" color="#9B99AE">{t('Soon')}</App.Text>
            </App.Flex>
          </App.Flex>
