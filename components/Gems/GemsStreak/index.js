  ...
  return (
    <App.Flex row gap={90} className={styles.container}>
      <App.Flex column flex={1} gap={12}>
        <App.Text>Trade Daily To Win {streaks[streaks.length - 1].multiplier}X Bonus Points!</App.Text>
      ...
      <App.Flex column align="center" gap={8}>
        <App.Flex justify="center" className={styles.badge}>
          <App.Text center size={18} weight={900} color="#FFD851" sx={{ textShadow: '0px 2.849px 5.697px rgba(182, 0, 0, 0.55)' }}>{getCurrentMultiplier()}X</App.Text>
        </App.Flex>
