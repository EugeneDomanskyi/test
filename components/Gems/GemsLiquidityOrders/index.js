...
const GemsLiquidityOrders = ({ loading }) => {
        ...
        <App.Flex row>
          ...
          {!isMobile ? (
            <>
              ...
              <App.Flex flex={1} center>
                <App.Text center weight={600} height={1} color="#A6DC37">{t('Total gems earned')}</App.Text>
              </App.Flex>
            </>
          ) : (
            <>
              ...
              <App.Flex flex={1} center>
                <App.Text center weight={600} height={1} color="#A6DC37">{t('Gems')}</App.Text>
              </App.Flex>
            ...
            liquidity[tab].length ? (
              ...
              <App.Flex column center height={200} gap={32}>
                <App.Flex column center gap={4}>
                  <App.Text>🚀</App.Text>
                  <App.Text>{t('Create your first order to start collecting gems')}</App.Text>
                </App.Flex>
          ...
          <App.Flex column sx={{ padding: 16 }} gap={8}>
            ...
            {tab != 'completed' ? (
              <>
                ...
                <App.Flex row align="center" justify="space-between">
                  <App.Text size={14} weight={400} height={1}>{t('Gems per minute')}</App.Text>
            ...
            <App.Flex row align="center" justify="space-between">
              <App.Text size={14} weight={400} height={1}>{t('Total gems earned')}</App.Text>
...
export default GemsLiquidityOrders