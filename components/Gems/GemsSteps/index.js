...
const steps = [
  {
    ...
    image: '/images/gems/gems-step-1-big.png',
    width: 181,
    height: 80
  },
  {
    subtitle: 'Step 2',
    title: 'Create orders to collect gems',
    image: '/images/gems/gems-step-2.png',
    width: 90,
    height: 81,
  },
  {
    ...
    image: '/images/gems/gems-step-3.png',
    width: 272,
    height: 94,
  },
]

const GemsSteps = ({ full = null }) => {
  return (
