const AppIcon = ({ icon, width, height, color, opacity, ...props }) => {
  const getIcon = () => {
    ...
    if (icon === 'info-shape') {
      return (
        <svg width={width ?? 31} height={height ?? 30} viewBox="0 0 31 30" fill="none" {...props}>
          <path
            fill={color ?? '#53F19C'}
            d="M13.114.664c1.035-.885 2.73-.885 3.78 0l2.369 2.04c.45.39 1.29.704 1.89.704h2.549a2.906 2.906 0 0 1 2.894 2.894v2.55c0 .585.315 1.44.705 1.89l2.04 2.368c.884 1.035.884 2.73 0 3.78l-2.04 2.369c-.39.45-.705 1.29-.705 1.89v2.549a2.906 2.906 0 0 1-2.894 2.894h-2.55c-.585 0-1.44.315-1.89.705l-2.369 2.04c-1.035.884-2.729.884-3.779 0l-2.37-2.04c-.45-.39-1.289-.705-1.889-.705H6.261a2.906 2.906 0 0 1-2.894-2.894v-2.564c0-.585-.315-1.425-.69-1.875L.652 16.875c-.87-1.035-.87-2.715 0-3.75l2.025-2.384c.375-.45.69-1.29.69-1.874V6.302A2.906 2.906 0 0 1 6.26 3.408h2.594c.585 0 1.44-.315 1.89-.705l2.37-2.04Z"
          />
          <path
            fill="#06382F"
            d="M16 9.667a1 1 0 1 0 0 2 1 1 0 0 0 0-2Zm-.24 3.18c-.793.066-2.96 1.793-2.96 1.793-.133.1-.093.093.013.28.107.18.094.193.22.107a40 40 0 0 1 .72-.454c1.414-.906.227 1.187-.38 4.714-.24 1.746 1.334.846 1.74.58.4-.26 1.474-1 1.58-1.074.147-.1.04-.18-.073-.346-.08-.114-.16-.034-.16-.034-.433.287-1.227.887-1.333.507-.127-.38.686-2.987 1.133-4.78.073-.427.273-1.36-.5-1.293Z"
          />
        </svg>
      )
    }
